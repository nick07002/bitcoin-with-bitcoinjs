...
async function start_p2pktr(keypair: Signer) {
    ...
    totalInputValue = utxos[0].value;
    let sendAmount = 547
    psbt.addOutput({
        address: "tb1qgt6wgp8089gxh9g6wnju6lah290pt798wfsy72", // self addr.
        value:  sendAmount,
    });

    // Add an output to send change back to ourself
    const feeSatoshis = 150; // <------ LOOK HERE --------------
    const myAddress = 'tb1qgt6wgp8089gxh9g6wnju6lah290pt798wfsy72';
